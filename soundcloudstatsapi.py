...
class SoundcloudStatsAPI():

    def __init__(self, auth_token, app_version, client_id, *args, **kwargs):
        self.req_headers = {
    ...
    def load_tracklist(self, limit=200, raw=False, headers=headers):
        if user_id is None:
            raise Exception('User must be set to query stats!')
        ...
        url = 'https://api-v2.soundcloud.com/users/{}/tracks'.format(self.user_id)
        
        res = req.request("GET", url, params=url_params, headers=self.headers)
    ...
    def load_track_stats(self, track, date_start, date_end, headers=headers):

        url = 'https://api-v2.soundcloud.com/users/soundcloud:users:{}/tracks/soundcloud:tracks:{}/stats/timeseries/plays'.format(self.user_id, track['id'])
    ...
    def load_track_by_date_stats(self, limit=200, dump=False):
    ...
    def load_platforms_for_track(self, track, date_start, date_end, headers=headers):
        url = 'https://api-v2.soundcloud.com/users/soundcloud:users:{}/tracks/soundcloud:tracks:{}/stats/top-lists/plays/podcast-app'.format(self.user_id, track['id'])
    ...
    def load_track_total(self, track, date_start, date_end):
        url = 'https://api-v2.soundcloud.com/users/soundcloud:users:{}/tracks/soundcloud:tracks:{}/stats/totals'.format(self.user_id, track['id'])
    ...
    def load_sc_plays_for_track(self, track, date_start, date_end):
        
        ts_from = ts_from_date(date_start)
        ts_to = ts_from_date(date_end)
        
        url = 'https://api-v2.soundcloud.com/users/soundcloud:users:{}/tracks/soundcloud:tracks:{}/stats/top-lists/plays/soundcloud-app'.format(self.user_id, track['id'])
